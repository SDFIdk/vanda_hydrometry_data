...
(
 ...
 CONSTRAINT PK_1 PRIMARY KEY ( station_uid )
);
CREATE INDEX station_IDX_station ON station (
    station_id
);
...
COMMENT ON COLUMN station.station_uid IS 'The unique identifier of the station, identical with the source (DMP)';
...
(
 ...
 CONSTRAINT FK_2 FOREIGN KEY ( station_uid ) REFERENCES station ( station_uid )
);
...
(
 ...
 station_uid          uuid NOT NULL,
 measurement_type_id  int NOT NULL,
 CONSTRAINT FK_3 FOREIGN KEY ( station_uid ) REFERENCES station ( station_uid ),
